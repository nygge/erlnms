...
%%% Author  : Ericsson
%%% Description : This was originally taken from the Erlang/OTP 
%%% "Sysytems principles document."
%%%
%%% Created : 13 Mar 2006 by Anders Nygren <anders.nygren@gmail.com>
%%%-------------------------------------------------------------------
...
create_install([RelFileName, RootDir]) ->
    create(RelFileName),
