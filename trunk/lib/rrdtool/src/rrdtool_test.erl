...
-export([create/2,update/0,
	 graph1/0,graph/0,
	 start_all/3,start_all/4,
	 stop_all/2,
	 mn_insert/4,
	 create_all/4]).
...
create(N,I) ->
    SampleInt={sec,15},
    Opts=[{step,SampleInt}],
    File="/home/anders/src/nms/rrdtool/priv/NE"++integer_to_list(N)++
    ...
    rrdtool:create(File,Opts,DSs,RRAs).

update() ->
    File="/home/anders/src/erlang/miniNMS/rrdtool/priv/test.rrd",
    Templ=["temp"],
    Vals=[{n,[12]}],
    rrdtool:update(File,Templ,Vals).
...
% start_all()->
%     pm_source:start(ne1_source,'1',1,1000),
%     pm_source:start(ne2_source,'2',1,1000),
%     pm_source:start(ne3_source,'3',1,1000),
%     pm_source:start(ne4_source,'4',1,1000),
%     pm_source:start(ne5_source,'5',1,1000),
%     pm_source:start(ne6_source,'6',1,1000),
%     pm_source:start(ne7_source,'7',1,1000),
%     pm_source:start(ne8_source,'8',1,1000),
%     pm_source:start(ne9_source,'9',1,1000),
%     pm_source:start(ne10_source,'10',1,1000).
